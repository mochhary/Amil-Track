  ...
  final List<Map<String, dynamic>> _onboardingSteps = [
    {
      ...
      'desc':
          'Tinggalkan buku manual. Amil Track membantu Anda mengelola data muzakki dengan rapi, aman, dan terstruktur di cloud.',
      'icon': Icons.library_books_rounded,
    },
    {
      'title': 'Kalkulator BAZNAS',
      'desc':
          'Tidak perlu bingung menghitung nisab. Sistem otomatis menghitung Zakat Profesi, Maal, dan Fitrah secara akurat.',
      'icon': Icons.calculate_rounded,
    },
    {
      'title': 'Kwitansi Instan',
      'desc':
          'Kirim bukti penerimaan zakat yang sah langsung ke WhatsApp muzakki hanya dengan satu sentuhan.',
      'icon': Icons.phonelink_ring_rounded,
    },
    {
      'title': 'Siap Memulai?',
      'desc':
          'Gunakan akun Google Anda untuk masuk. Data Anda akan disinkronisasikan dan tidak akan hilang meskipun berganti HP.',
